...
・何らかのキーイベント等によって、ダイアログの表示用メソッドを呼ぶ(多くの場合、showメソッド)
・親となるダイアログやシステムクラスのキーイベントを全て解除
・ゲームキャンバス上に、アイテム一覧のダイアログを表示する
・自身のキーイベントを登録する。クリックでアイテム選択して閉じる、など

ダイアログを閉じた場合は、
・自身のキーイベントを全て解除する
・ゲームキャンバス上に表示しているダイアログを削除する
・親となるダイアログやシステムクラスのキーイベントを登録
