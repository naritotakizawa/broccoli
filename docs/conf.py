...
latex_documents = [
    (master_doc, 'broccoli.tex', 'broccoli Documentation',
     'NaritoTakizawa', 'manual'),
]
...
man_pages = [
    (master_doc, 'broccoli', 'broccoli Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'broccoli', 'broccoli Documentation',
     author, 'broccoli', 'One line description of project.',
     'Miscellaneous'),
]